...
It should be also mentioned, that the two events observed in data for the signal region of~\cite{bib:CMS:DT_8TeV}, are not contained in any of the signal regions in the here presented analysis.
...
In the current analysis, the background was estimated between $19-24$ events for the low \ias signal regions and $2.5-2.6$ for the high \ias regions.
