...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\chapter{Selection requirements in the ``tag-and-probe'' samples}
\label{app:TagAndProbeRequirements}

\renewcommand{\arraystretch}{1.4}
\begin{table}[!h]
\centering
\caption{Event selection cuts for the muon ``tag-and-probe'' sample that is used to estimate the uncertainty on the muon scale factor \muonscalefactor.}
...
\midrule
\multirow{5}{*}{Candidate track selection}                     &  Good quality selection \\
                                                               &  Kinematic selection    \\
                                                               &  Lepton/jet veto        \\   
                                                               &  Isolation selection    \\  
                                                               &  $\nhits>5$             \\  
...
\begin{table}[!h]
\centering
\caption{Event selection cuts for the tau ``tag-and-probe'' sample that is used to estimate the uncertainty on the tau scale factor \tauscalefactor.}
...
\begin{table}[!h]
\centering
\caption{Event selection cuts for the electron ``tag-and-probe'' sample that is used to estimate the uncertainty on the electron scale factor \electronscalefactor.}
