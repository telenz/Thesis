...
\end{figure}
A comparison between the energy release by MIPs (\ias) in data and simulation for high-purity tracks (as defined in \cite{bib:CMS:Tracking_2010}) with \pt$>10\gev$ and $|\eta|<2.1$ can be found in Fig.~\ref{fig:Data-MC-Dedx_MIPs}.
\begin{figure}[!bt]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackASmiSmallRange_log_MIPs.pdf}
  \end{tabular}
  \caption{Normalized \ias distribution for MIPs in data and simulation for high-purity tracks (as defined in \cite{bib:CMS:Tracking_2010}) with \pt$>10\gev$ and $|\eta|<2.1$. \textcolor{red}{FIXME: take MIP selection}}
