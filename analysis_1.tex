...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \frame{\includegraphics[width=0.30\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/BendedPionTrack.png}}
...
\end{equation*}
The factor 300 $\cdot$ 265 ADC/mm is in principal an arbitrary number. 
