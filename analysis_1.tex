...
It can be seen, that for lifetimes of \ctau=50\cm  for a given signal selection effieciency improvemnts up to a factor of 15 for masses of 500\gev and up to a factor of 4 for a chargino mass of 100\gev can be reached.
For shorter lifetimes of \ctau=5\cm, the iimprovemnt reduces to a factor of 10 to 11.
\begin{figure}[!bt]
  \centering 
  \begin{tabular}{c}
