...
\hyphenation{va-li-date}
\hyphenation{Kenn-gr}
\hyphenation{leich-tes-te}
\hyphenation{De-tek-tor}
\hyphenation{elek-tro-ma-gne-tisch-en}
\hyphenation{Schwer-punkts-en-er-gie}
\hyphenation{Stan-dard-mo-dell-un-ter-grunds}
...
\setlength{\cftbeforepartskip}{30pt}
\setlength{\cftbeforetoctitleskip}{-0.1em}
% Dots after chapter numbers
\renewcommand{\cftchapaftersnum}{.}%
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}

%Indent section numbres
...
\bookmarksetup{startatroot} \cleardoublepage  \appendix 
\addtocontents{toc}{\protect\vskip30pt} 
\addtocontents{titletoc}{\protect\renewcommand\protect\cftchappresnum{\appendixname\ }}
\input{Appendix/appendix_analysis.tex} \input{Appendix/appendix_resolution.tex}
