...
FIXME: In contrast to quarks, leptons are not strongly interacting, thus they only couple weakly and - in case they carry a non-zero electrical charge - electromagnetically to other particles.
...
Furthermore, anisotropies of the cosmic microwave background as well as Type Ia supernovae red shifts and the measurement of baryon acoustic oscillations strongly suggests the existence of Dark Matter~\cite{bib:Planck_2015}.
