...
Phenomenological MSSM models surviving these constraints and which have a wino-like neutralino as lightest supersymmetric particle do also contain frequently a metastable chargino.
In a fraction of $\sim 25\%$ of these models, the metastable chargino decays inside the tracker, calorimeter or muon chamber.
Furthermore, in these scenarios, the mass splitting between chargino and neutralino is typically of the order of $\sim160\mev$~\cite{bib:pMSSMScan_2013}.
