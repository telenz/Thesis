...
The measured resolution in data is compared to the resolution in a simulated \GAMJET sample. This is introduced in Section~\ref{res:sec:SimulatedSamples}.
...
The event selection is described in Section~\ref{res:sec:EventSelection}.
...
Thus, the uncertainties on the correction factors that are only applied to the data samples are varied up and down within their $1\sigma$-uncertainties.
