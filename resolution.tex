...
Particles belonging to a jet are clustered with the anti-k$_{\text{t}}$ jet clustering algorithm~\cite{bib:JetClustering_2008} with a radius parameter of R=0.5~\cite{Cacciari:2008gp}.
...
But since the transverse momentum of a jet is defined as the sum of all particles' transverse momenta that are clustered within a jet cone of FIXME, the jet \pt can be lower than the \pt of the original parton.
...
The increasing statistical uncertainties for low photon \pt arise through the requirements of $\alpha=\frac{\ptsecondrecojet}{\ptgamma}<0.2$ and FIXME \pt of the second jet. 
...
Due to the huge QCD-multijet cross section, a sizable fraction of dijet events can survive the strict photon selection (see Section~\ref{subsec:PhotonSelection}) if a jet is misidentified as a photon.
...
The observed difference in the results of the two approaches is taken as a systematic uncertainty FIXME.
...
In order to estimate the uncertainty, the flavour composition in simulation is varied by 10\% 
%and the weighted mean of the quark and the gluon resolution is calculated. Finally,
...
This approach might overestimate the uncertainty FIXME, since the difference in \rhores associated with different jet clustering radii may include other effects than out-of-cone showering.
