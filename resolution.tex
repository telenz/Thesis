...
Examplary extrapolitions for the imbalance and the total resolution in data and simulation are shown in Fig.~\ref{FIXME}.
The full set for each \ptgamma and $|\etafirstjet|$ bin can be found in Appendix~\ref{FIXME}.
...
\begin{figure}[hb]
 \centering
  ...
  \caption{Data-to-simulation resolution ratios, fitted with a horizontal line for four different $|\etafirstjet|$-ranges: 
           \mbox{$|\eta^{\text{1st jet}}| < 0.5$}, \mbox{$0.5\le|\eta^{\text{1st jet}}| < 1.1$}, \mbox{$1.1\le|\eta^{\text{1st jet}}| < 1.7$}, \mbox{$1.7\le|\eta^{\text{1st jet}}| < 2.3$}.}
...
Table~\ref{res:tab:FinalResults} summarises the ratio results determined with data collected during the year 2012 with their statistical and systematic uncertainties.
