...
//=========  (Mon Nov 24 13:36:31 2014) by ROOT version5.32/00
   ...
   grae->SetPoint(0,0.25,1.052);
   grae->SetPointError(0,0.25,0.25,0.06216912,0.06315061);
   grae->SetPoint(1,0.8,1.057);
   grae->SetPointError(1,0.3,0.3,0.05629387,0.05727128);
   grae->SetPoint(2,1.4,1.096);
   grae->SetPointError(2,0.3,0.3,0.06428841,0.06525335);
   grae->SetPoint(3,2,1.134);
   grae->SetPointError(3,0.3,0.3,0.09192388,0.09377633);
   ...
   grae->SetPoint(0,0.25,1.052);
   grae->SetPointError(0,0.25,0.25,0.012,0.012);
   grae->SetPoint(1,0.8,1.057);
   grae->SetPointError(1,0.3,0.3,0.012,0.012);
   grae->SetPoint(2,1.4,1.096);
   grae->SetPointError(2,0.3,0.3,0.017,0.017);
   grae->SetPoint(3,2,1.134);
   grae->SetPointError(3,0.3,0.3,0.035,0.035);
   ...
   TH1F *Graph_Graph_Graph_Res_2011_stat245 = new TH1F("Graph_Graph_Graph_Res_2011_stat245","Graph",100,0,2.3);
   Graph_Graph_Graph_Res_2011_stat245->SetMinimum(1.0271);
   Graph_Graph_Graph_Res_2011_stat245->SetMaximum(1.1819);
   Graph_Graph_Graph_Res_2011_stat245->SetDirectory(0);
   Graph_Graph_Graph_Res_2011_stat245->SetStats(0);
   Graph_Graph_Graph_Res_2011_stat245->SetLineStyle(0);
   Graph_Graph_Graph_Res_2011_stat245->SetMarkerStyle(20);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetTitle("|#eta|");
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetNdivisions(505);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph_Res_2011_stat245->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetTitle("Data/MC ratio  for JER");
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph_Res_2011_stat245->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph_Res_2011_stat245->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Res_2011_stat245->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Res_2011_stat245->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Res_2011_stat245->GetZaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Res_2011_stat245->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph_Res_2011_stat245);
   ...
   TH1F *Graph_Graph_Graph_Graph_Res_2011_stat2456 = new TH1F("Graph_Graph_Graph_Graph_Res_2011_stat2456","Graph",100,0,2.3);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetMinimum(1.0271);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetMaximum(1.1819);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetDirectory(0);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetStats(0);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetLineStyle(0);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->SetMarkerStyle(20);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetTitle("|#eta|");
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetNdivisions(505);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetTitle("Data/MC ratio for JER");
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetZaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph_Graph_Res_2011_stat2456->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph_Graph_Res_2011_stat2456);
