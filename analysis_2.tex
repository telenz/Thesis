...
\subsubsection*{Event based selection}
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/hMet_log_4Signals_noSelection.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/h1stjetpt_log_4Signals_noSelection.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/hDeltaPhiMaxbeforeCut_lin_chiTrackstriggerRequirementsTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/hDeltaPhiJetMetMaxbeforeCut_lin_chiTrackstriggerRequirementsTrigger.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackEta_lin_chiTracksQCDsupressionTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackHighPurity_lin_chiTracksQCDsupressionTrigger.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackNLostMid_lin_chiTracksQCDsupressionTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackNLostInner_lin_chiTracksQCDsupressionTrigger.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackd0_lin_chiTracksQCDsupressionTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackdz_lin_chiTracksQCDsupressionTrigger.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackIsolation_lin_chiTracksCandidateSelectionTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackCaloIsolationSmallRange_lin_chiTrackspreselectionTrigger.pdf}
  \end{tabular}
