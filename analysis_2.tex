...
A summary and a cutflow table of the event selection cuts is given in table~\ref{blabla}.\\
...
%  \end{tabular}
%  \caption{Efficiency of the analysis selection cuts for simulated signal and background samples.}
%  \label{fig:CutFlow}
%\end{figure}
