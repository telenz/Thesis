...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackIsolationSmallRange_lin_afterTrackPreselection.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackCaloIsolationSmallRange_lin_afterTrackPreselection.pdf}
  \end{tabular}
...
\begin{figure}[!tb]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackPtSmallRange_log_afterPreselection.pdf}
