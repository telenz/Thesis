...
The signal candidate event selection closely follows the selection required in~\cite{bib:CMS:DT_Thesis,bib:CMS:DT_8TeV_AN}.
...
\begin{itemize}
\item Charged hadron energy fraction (CHF) $>0.2$
\item Charged electromagnetic energy fraction (CEF) $<0.5$
\item Neutral hadron energy fraction (NHF) $<0.7$
\item Neutral electromagnetic energy fraction (NEF) $<0.7$.
\end{itemize}
