...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/hDeltaPhiMaxbeforeCut_lin_afterTrigger.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/hDeltaPhiMaxbeforeCut_lin_afterTrigger.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackEta_lin_QCDsupression.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackHighPurity_lin_QCDsupression.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackNLostMid_lin_QCDsupression.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackNLostInner_lin_QCDsupression.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackd0_lin_QCDsupression.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackdz_lin_QCDsupression.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackIsolationSmallRange_lin_afterCandidateSelection.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/htrackCaloIsolationSmallRange_lin_afterCandidateSelection.pdf}
  \end{tabular}
