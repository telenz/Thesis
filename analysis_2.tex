...
\multirow{4}{*}{\makecell[l]{Event based \\ selection}}        &  \multirow{2}{*}{Trigger selection}   & \makecell[l]{$\ptfirstjet>100\gev$ \hfill with $|\eta_{\text{1.jet}}|<2.4$,  \\
                                                               ...
                                                               &  \multirow{2}{*}{QCD supression}      & \makecell[l]{$\Delta\phi_{\text{max}} \left( \text{jet}_i, \text{jet}_j  \right)<2.7$  for all jets with \\ \hfill $\pt>20\gev$, $|\eta|<4.5$}\\
...
\begin{figure}[!tb]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/AnalysisSelection/chiTracksfullSelectionNoTriggerCuts/htrackPtSmallRange_log.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/AnalysisSelection/chiTracksfullSelectionNoTriggerCuts/htrackASmiSmallRange_log.pdf}
  \end{tabular}
