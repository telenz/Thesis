...
\begin{equation}
\mathcal{L} =  \text{Poisson}\left( n |\lambda = b \cdot (1+\delta_b)+\mu\cdot s  (1+\delta_s)  \right)\, p\left(\delta_b\right)\, p\left(\delta_s\right).
\end{equation}
that already appeared in Eq.~\ref{eq:CLsb_CLb}.
