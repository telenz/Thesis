...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.48\textwidth]{figures/analysis_2/Background/NValidForFakes_chiTracksfullSelectionNoTriggerCuts.pdf}
  \end{tabular}
...
\multirow{12}{*}{\makecell[l]{Event-based \\ selection}}       &  Two global muons with & $\pt>25\gev$ \\
                                                               ...
                                                               &                        & $\left.\frac{\chi^2}{\ndof}\right\rvert_{\text{global track}}<10$ \\
                                                               &                        & $|d0|<0.2\cm$  \\
                                                               &                        & $|dz|<0.5\cm$  \\
...
When applying a \Zlep selection plus the candidate track selection, the selected tracks should be mostly fakes.
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis_2/Background/NLostInnerPlusMiddleForAllBkg_chiTracksfullSelectionNoQCDCutsNoTrigger.pdf}
  \end{tabular}
...
\vspace{40pt}
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis_2/Background/hASmi_fakes_ECalaoLe5_trackPtGt20.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis_2/Background/hASmi_fakes_ECalaoLe5_trackPtGt40.pdf}
  \end{tabular}
...
As for the fakes, the leptonic background estimation is split into two parts.
...
This method relies on the simulation of the lepton reconstruction efficiencies which is known to be reasonably accurate~\cite{bib:CMS:elec_recoEff,bib:CMS:muon_recoEff,bib:CMS:TauReconstruction_7TeV}.
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Electrons_MCCR_MCSR.pdf}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Taus_MCCR_MCSR.pdf}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Muons_MCCR_MCSR.pdf}
  \end{tabular}
...
\begin{figure}[!tb]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Electrons_MCCR_DataCR.pdf}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Taus_MCCR_DataCR.pdf}
    \includegraphics[width=0.33\textwidth]{figures/analysis_2/Background/hASmi_Muons_MCCR_DataCR.pdf}
  \end{tabular}
...
The largest deviation from one of the ratio of the number of events in the signal region and the control region including its 1-sigma statistical uncertainty is taken as systematic uncertainty.
...
\begin{figure}[!h]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis_2/Background/hASmi_SRbinning_fakes_ECalaoLe5_trackPtGt20.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis_2/Background/hASmi_SRbinning_fakes_ECalaoLe5_trackPtGt40.pdf}
  \end{tabular}
