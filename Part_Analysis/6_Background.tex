...
The reader will recognise, that the importance of the two contributions, the fake and leptonic background, is very different to this search.
...
Finally, an optimisation in the track variables \pt and \dedx is carried out (see Chapter~\ref{ch:Optimisation}) to ensure an ideal selection for the search for short and  highly ionising tracks.
...
\label{sec:FakeBkg}
Fake tracks are tracks that are not reconstructed out of the tracker hits of one single particle.
