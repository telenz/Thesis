...
\begin{figure}[!b]
  ...
  \begin{tabular}{c}
    ...
    \includegraphics[width=0.48\textwidth]{figures/analysis_2/Background/NValidForFakes_chiTracksfullSelectionNoQCDCutsNoTrigger_2.pdf}
  \end{tabular}
  \caption{FIXME: Normalised distribution of the number of hits for fake tracks in the simulated \WJets sample. To increase the statistical precision, only the candidate track selection from Table~\ref{tab:SummaryCuts} is applied.}
