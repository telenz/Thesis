...
%\footnote{Required quality criteria: $\nhits \geq 8$; $\nhits^{\text{Pixel}} \geq 2$; Number of $\Delta E/\Delta x$ measurements $\geq 6$; $\chi^2/\ndof < 5$; high-purity tracks as defined in~\cite{bib:CMS:Tracking_2010}; vertex compatibility; $\sigma_{\pt}/\pt \leq 0.25$}
