...
The CMS tracker system provides a measurement of the particle energy loss for each hit in the tracker.
...
The relevant particle properties are the velocity ($\beta$), the Lorentz factor ($\gamma$) and the charge (z) of the incident particle.
...
\begin{figure}[!t]
  ...
  \label{fig:landau}
\end{figure}
Theoretically it extends to infinite energies, however in nature the maximal deposited energy is of course limited by the full energy of the particle.
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
  \includegraphics[width=0.58\textwidth]{figures/analysis/PixelCalibration/dEdx_Bethe_Landau.png}
  \end{tabular}
...
One of the estimators for determining the \dedx of a track is the harmonic-2 estimator
\begin{equation}
...
This imperfection of the gain calibration can be seen in Fig.~\ref{fig:StabilityPlot_beforeCalibration}, where the mean of the harmonic-2 estimator $\langle\ihtwo \rangle$ for high-quality muon tracks with $\pt>45\gev$ over the full data-taking period in 2012 is shown.
...
\begin{figure}[!t]
  ...
  \end{tabular}
  \caption{Mean of all tracks' \dedx (harmonic-2 estimator) over the full year 2012. Only pixel hits are taken into account. Every data point corresponds to one run (see Section~\ref{ch:LargeHadronCollider} for a definition of a run).} 
...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
  \includegraphics[width=0.49\textwidth]{figures/analysis/PixelCalibration/Landau_Module_352476680.pdf}
  \end{tabular}
...
\begin{figure}[!t]
  ...
  \end{tabular}
  \caption{Mean of all tracks' \dedx (harmonic-2 estimator) over the full year 2012 after applying the calibration factors, resulting in an average \dedx of 3.51 MeV/cm. Only pixel hits are taken into account. Every data point corresponds to one run.} 
...
\end{equation}
where $N_e$/ADC is the number of electrons corresponding to one calibrated ADC count and 3.61\,\ev is the  mean energy needed to create one electron-hole pair in silicon at $-10\degree$C.
...
In \cite{bib:Quertenmont_2010}, the absolute gain calibration was done with the help of the most probable \dedx of muons, 
...
\begin{figure}[!t]
  ...
  \end{tabular}
  \caption{Mean of all tracks' \dedx (harmonic-2 estimator) measured in the silicon strip detector over the full year 2012. The average most probable \dedx is $\ihtwo=3.303\,\mev/\cm$. Every data point corresponds to one run.} 
...
As mentioned before, it is difficult to find a robust estimator for the most probable energy loss of a particle, if only a few measurements of $\Delta E/ \Delta x$  along the particle trajectory are available.
...
That a measured sample has been drawn from a specific distribution can be tested with the so-called Smirnov-Cram\'{e}r-von Mises test~\cite{bib:Anderson:CramerVonMises_1962,bib:James:StaticticalMethods_2006}.
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/PixelCalibration/Discriminator_template_data_pixel_2012.pdf}
    \includegraphics[width=0.49\textwidth]{figures/analysis/PixelCalibration/Discriminator_template_mc_pixel_2012.pdf}
  \end{tabular}
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.45\textwidth]{figures/analysis/PixelCalibration/rocplot_wjets_mass_100GeV_ctau_5cm.pdf} 
    \includegraphics[width=0.45\textwidth]{figures/analysis/PixelCalibration/rocplot_wjets_mass_100GeV_ctau_50cm.pdf} \\
    \includegraphics[width=0.45\textwidth]{figures/analysis/PixelCalibration/rocplot_wjets_mass_500GeV_ctau_5cm.pdf} 
    \includegraphics[width=0.45\textwidth]{figures/analysis/PixelCalibration/rocplot_wjets_mass_500GeV_ctau_50cm.pdf}
  \end{tabular}
