...
Within this anlysis the calibration is performed on module level because ROCs within one module are acceptably calibrated within 10\% (Fig.~\ref{FIXME} in Appendix~\ref{FIXME}) while discrepancies larger than 20\% occur frequently on module level (Fig.~\ref{FIXME} in Appendix~\ref{FIXME}).
