...
\begin{figure}[!t]
  \centering 
  \begin{tabular}{c}
  \includegraphics[width=0.58\textwidth]{figures/analysis_2/dEdx_Bethe_Landau.png}
  \end{tabular}
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.45\textwidth]{figures/analysis/rocplot_wjets_mass_100GeV_ctau_5cm.pdf} 
    \includegraphics[width=0.45\textwidth]{figures/analysis/rocplot_wjets_mass_100GeV_ctau_50cm.pdf} \\
    \includegraphics[width=0.45\textwidth]{figures/analysis/rocplot_wjets_mass_500GeV_ctau_5cm.pdf} 
    \includegraphics[width=0.45\textwidth]{figures/analysis/rocplot_wjets_mass_500GeV_ctau_50cm.pdf}
  \end{tabular}
