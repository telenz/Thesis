...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.50\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi_ProductionAndDecay.pdf}
  \end{tabular}
...
\begin{figure}[!h]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.26\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi_GammaZ.pdf}
    \includegraphics[width=0.26\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi_Scalar.pdf}
    \includegraphics[width=0.26\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi_Squark.pdf}
  \end{tabular}
...
\begin{figure}[!h]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.26\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi0_WBoson.pdf}
    \includegraphics[width=0.26\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/ChiChi0_Squark.pdf}
  \end{tabular}
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \includegraphics[width=0.49\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/PtOfPions.pdf}
  \end{tabular}
  \caption{Transverse momentum distribution of pions coming from chargino decays into neutralinos with a mass gap of $\Delta m_{\chipm\chiO}=150\mev$.}
  \label{fig:ptOfPions}
\end{figure} 
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
    \hspace{15pt} \frame{\includegraphics[width=0.39\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/BendedPionTrack.png}}
  \end{tabular}
...
In summary, since an early decaying chargino is not reconstructed as a particle-flow (PF) particle, the event signature of a chargino-neutralino or a chargino-pair event consists only of one or two - potentially - disappearing tracks. 
...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
  \includegraphics[width=0.49\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/hgenPtChiMiddleBinning_log.pdf}
  \end{tabular}
...
In~\cite{bib:CMS:HSCP_8TeV}, a minimum number of eight hits are required for every track, whereas in~\cite{bib:CMS:DT_8TeV} a minimum of seven hits are required.
...
\begin{figure}[!b]
  ...
  \includegraphics[width=0.49\textwidth]{figures/analysis/MotivationAndGeneralSearchStrategy/RecoEffTracksZoom.pdf}
  \end{tabular}
