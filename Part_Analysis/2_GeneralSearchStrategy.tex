...
\begin{figure}[!b]
  \centering 
  \begin{tabular}{c}
  \includegraphics[width=0.49\textwidth]{figures/analysis_2/MotivationAndGeneralSearchStrategy/htrackPtSmallRangeCoarseBinning_log_noSelection.pdf}
  \end{tabular}
  \caption{Normalised distribution of the transverse momentum of chargino tracks for two different signal models. No selection is applied.} 
...
\end{figure}
Since a minimum number of three hits is required for track reconstructtion, there are no tracks with $\nhits<3$.
